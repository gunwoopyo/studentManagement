...
public slots:
    ...
    void on_studentTable_cellClicked(int row);   //  searchTable 행 클릭 함수
    void on_deleteStudentPushButton_clicked();  //  학생 삭제 버튼 함수
    void studentTable(Student* student = nullptr);  //  학생 조회 함수
    void applyStudentTableRowColors(QTableWidget* studentTable);  //  searchTable 행 색 적용
    ...
    void applyCourseTableRowColors(QTableWidget* courseTable);  //  수강 과목 courseTable 행의 색 적용 함수
