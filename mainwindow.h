...
public slots:
    ...
    void on_clearStudentDataPushButton_clicked();  // 초기화 버튼
    ...
    void courseSearchTable(int stnID, QString name, QString year, QString major);  // 학생 조회
    void on_courseAllSearchPushButton_clicked();  // 학생 전체 조회

    void on_courseTable_cellClicked(int row);   // 테이블 셀 선택
