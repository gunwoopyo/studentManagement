...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        tabWidget->setGeometry(QRect(30, 70, 931, 621));
        search = new QWidget();
        search->setObjectName("search");
        searchFrame = new QFrame(search);
        searchFrame->setObjectName("searchFrame");
        searchFrame->setGeometry(QRect(40, 80, 851, 101));
        ...
        searchStudentIDText->setGeometry(QRect(80, 30, 101, 26));
        ...
        searchMajorComboBox->setGeometry(QRect(600, 30, 101, 26));
        searchMajor = new QLabel(searchFrame);
        searchMajor->setObjectName("searchMajor");
        searchMajor->setGeometry(QRect(560, 30, 31, 18));
        ...
        searchStudentNameText->setGeometry(QRect(260, 30, 101, 26));
        searchStudentName = new QLabel(searchFrame);
        searchStudentName->setObjectName("searchStudentName");
        searchStudentName->setGeometry(QRect(220, 30, 31, 18));
        ...
        registrationStudentPushButton->setGeometry(QRect(740, 20, 71, 51));
        QFont font2;
        ...
        searchTable->setGeometry(QRect(110, 260, 721, 301));
        searchTable->horizontalHeader()->setDefaultSectionSize(140);
        label = new QLabel(search);
        label->setObjectName("label");
        label->setGeometry(QRect(110, 230, 81, 18));
        QFont font3;
        ...
        searchStudentPushButton->setGeometry(QRect(720, 40, 81, 31));
        ...
        searchAllStudentButton->setGeometry(QRect(810, 40, 81, 31));
        searchAllStudentButton->setFont(font2);
        label_7 = new QLabel(search);
        label_7->setObjectName("label_7");
        label_7->setGeometry(QRect(40, 30, 171, 31));
        QFont font4;
        ...
        clearStudentDataPushButton->setGeometry(QRect(630, 40, 81, 31));
        ...
        addCourseFrame->setGeometry(QRect(40, 80, 851, 101));
        ...
        courseCourseName->setGeometry(QRect(280, 60, 61, 20));
        ...
        courseCourseNameComboBox->setGeometry(QRect(350, 60, 101, 26));
        ...
        courseMajorComboBox->setGeometry(QRect(120, 60, 101, 26));
        ...
        courseGradeComboBox->setGeometry(QRect(630, 220, 81, 31));
        courseGradePushButton = new QPushButton(addCourse);
        courseGradePushButton->setObjectName("courseGradePushButton");
        courseGradePushButton->setGeometry(QRect(720, 220, 71, 31));
        ...
        deleteCoursePushButton->setGeometry(QRect(800, 220, 71, 31));
        ...
        clearCourseDataPushButton->setGeometry(QRect(630, 40, 81, 31));
        ...
        label_9->setGeometry(QRect(400, 30, 201, 41));
        QFont font5;
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        label_7->setText(QCoreApplication::translate("MainWindow", "\355\225\231\354\203\235 \353\223\261\353\241\235  \354\202\255\354\240\234  \354\210\230\354\240\225", nullptr));
        ...
        tabWidget->setTabText(tabWidget->indexOf(search), QCoreApplication::translate("MainWindow", "\355\225\231\354\203\235 \353\223\261\353\241\235 \354\202\255\354\240\234 \354\210\230\354\240\225", nullptr));
